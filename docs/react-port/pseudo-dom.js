...
class Element {
  ...
  set textContent(value) {
    ...
    asyncMessage({action:'setTextContent',optional:true,id:this.id,textContent:this.textContent});
  }
  get textContent() {
  ...
  constructor(nodeName) {
    ...
    this._style = new Proxy(this._style, styleProxy);
...
var styleProxy = {
  ...
  set(target, prop, value) {
    ...
    // console.log({action:'setStyle',id:target.node.id,attribute:kebabProp,value:val});
    // console.log('setStyle',target, prop, value);
